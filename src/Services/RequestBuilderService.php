...
class RequestBuilderService extends AllGenerator {
    ...
    public function creating(array $model, string $name, string $namespace): void {
        /* @var Model $entity */
    ...
    public function updating(array $model, string $name, string $namespace): void {
        /* @var Model $entity */
        // Read boilerplate from storage
        $stub = $this->getStub();
    ...
    protected function getTableColumns($table): array {
        ...
        foreach ($columns as $column) {
            $detail[$column] = Schema::getColumnType($table, $column);
        }
